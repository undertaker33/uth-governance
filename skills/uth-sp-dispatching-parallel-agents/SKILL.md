---
name: uth-sp-dispatching-parallel-agents
description: Use when an owning UTH scene needs parallel delegation across 2+ independent problem domains with disjoint context or write scopes. Do not use for tightly coupled work, unclear tasks, or single small changes.
---
