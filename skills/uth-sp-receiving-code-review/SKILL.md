---
name: uth-sp-receiving-code-review
description: Use inside uth-review when processing external code review feedback before deciding whether to route fixes to uth-dev or uth-debug. Do not implement fixes directly from this skill.
---
