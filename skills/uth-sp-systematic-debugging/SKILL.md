---
name: uth-sp-systematic-debugging
description: Use inside uth-debug when diagnosing a bug, failing test, build error, regression, or unexpected behavior before proposing a fix. Do not use as a top-level router or feature-development flow.
---
...
1. **Create Failing Test Case**
   ...
   - Use the `uth-sp-test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **uth-sp-test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **uth-sp-verification-before-completion** - Verify fix worked before claiming success
