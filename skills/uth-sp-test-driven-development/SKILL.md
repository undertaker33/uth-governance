---
name: uth-sp-test-driven-development
description: Use inside uth-dev or uth-debug when changing business behavior, API behavior, permission rules, state machines, core flows, or regression behavior with a feasible test path. Do not use for pure copy, style, or display-only changes unless requested.
---
