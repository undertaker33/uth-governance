---
name: uth-sp-verification-before-completion
description: Use before an owning UTH scene claims code or Git work is complete, fixed, passing, ready, or releasable. Do not use for pure read-only analysis or explicitly unverified interim findings.
---
